  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      ColumnLayout {
        ...
        Text {
          text: root.stampEnabled ? "Background overlay active" : "Stamp overlay disabled"
    ...
    RowLayout {
      ...
      Button {
        ...
        selected: true
        onClicked: {
          if (root.hostWidget && typeof root.hostWidget.close === "function") {
            root.hostWidget.close()
          }
        }
      }
    }
